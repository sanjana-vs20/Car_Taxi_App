...
const Navbar = () => {
  ...
  return (
    ...
    text-gray-600 border-b border-borderColor relative transition-all ${location.pathname === "/" && "bg-light"}`}>
        ...
        <div className={`max-sm:fixed max-sm:h-screen max-sm:w-full max-sm:top-16 max sm:border-borderColor right-0 flex
        flex-col sm:flex-row items-start sm::item-center gap-4 sm:gap-8 max-sm:p-4 
